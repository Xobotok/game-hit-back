...
/**
 * Game represents the model behind the search form of `app\models\Game`.
 */
class Game extends GameModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'description', 'big_icon_link', 'small_icon_link', 'video', 'developer', 'publichser', 'release_date', 'platform'], 'safe'],
        ];
    }
